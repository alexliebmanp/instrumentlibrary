...
class Serial:
    ...
    def __init__(self,communication_args):
        '''Instantiate the Serial connection. We use the pyvisa package for communication via a virtual comm port (ie not directly accessing the comm port). Main difference from GPIB module is the addition of a terminator. In the future, I could think about combining these two kinds of devices.
